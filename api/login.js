...
export default async function handler(req, res) {
  ...
  try {
    ...
    res.status(200).json({ ok: true, id: v.id, role: v.role, tabs: v.tabs, seeProfit: v.seeProfit, gachaEdit: v.gachaEdit, buyEdit: v.buyEdit, shops: v.shops, shopFeats: v.shopFeats });
  } catch (err) {
